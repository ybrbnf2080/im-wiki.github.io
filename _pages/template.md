...
**Получение рабочей визы и визы финансово независимого лица:**
...
**Получение легального статуса при вступлении в брак с гражданином страны:**
...
**Болезни, опасные животные и растения:**

_У нас пока нет ответа на данный вопрос. Вы можете предложить свой вариант._

{% include edit %}

**Наличие лесов, гор, воды:**
...
**Контроль качества продуктов и оказываемых услуг:**
...
**Основные культурные особенности местных жителей:**
...
**Расизм и прочая дискриминация:**

_У нас пока нет ответа на данный вопрос. Вы можете предложить свой вариант._

{% include edit %}

**Толерантность к ЛГБТ:**
...
**Политическая ситуация, которая может повлиять на дальнейшее развитие:**
...
**Как открыть банковский счёт (в том числе в нелегальном статусе и статусе туриста):**
...
**Варианты для самых бедных (хостелы, ночлежки):**
...
**Общий уровень мед.помощи, лечение тяжёлых заболеваний:**
...
**Детские сады (бесплатные и платные):**

_У нас пока нет ответа на данный вопрос. Вы можете предложить свой вариант._

{% include edit %}

**Школы(бесплатные и платные):**
